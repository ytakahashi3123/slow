...
from slow.boundary.boundary import boundary as boundary_class
from slow.gradient.gradient import gradient as gradient_class
...
def main():
  ...
  meshdata         = meshdata_class()
  flowfield        = flowfield_class()
  boundary         = boundary_class()
  gradient         = gradient_class()
  rhs              = rhs_class()
  time_integration = time_integration_class()
