...
def haenel(var_a, var_b, vecx, vecy, vecz, vect1x, vect1y, vect1z, specfic_heat_ratio, specific_heat_volum, flux_rhs):
...
def rhs_advection_inner(args):
  n_face, var_primitiv, var_gradient, var_limiter, var_rhs, area_vec, length, face2cell, kind_scheme, eps_muscl, specfic_heat_ratio, specific_heat_volum, flux_rhs = args
  # Face area vector
